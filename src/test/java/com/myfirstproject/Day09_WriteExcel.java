...
public class Day09_WriteExcel {
    ...
    /*With Java we can use most of microsoft files to get  data for automation.*/
    //when we get data from external source(excel), it is known DDT(DATA DRIVEN TESTING
    /*Apache Poi library we use */
...
//        Sheet sheet1 = workbook.getSheet("Sheet1");
        Sheet sheet1 = workbook.getSheetAt(0);//we can alsp use getSheet instead of getSheetAt
//    Go to the first row
